    ...
    >
      ...
      {current ? (
        ...
        <div className="bg-white rounded-[2.5rem] p-8 shadow-[0_12px_40px_rgba(0,0,0,0.06)] border border-slate-50 flex flex-col items-center text-center">
          ...
          {/* FIXAD: HÄR LÅG DEN STORA CIRKELN! Nu är det en snygg liten ikon istället. */}
          {nextRealActivity && (
            <div className="mt-10 pt-6 border-t border-slate-100 w-full">
              ...
              <div className="bg-slate-50 rounded-2xl p-4 flex items-center gap-5 border border-slate-100">
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm border border-slate-200 flex-shrink-0 text-xl">
                  ⏳
                </div>
